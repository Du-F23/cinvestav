                ...
                <div class="profile-desc">
                    <div class="profile-pic">
                        <div class="count-indicator">
                            <img class="img-xs rounded-circle " src="{{ Storage::url( Auth::user()->img) }}" alt="Profile picture for {{ Auth::user()->name }}">
                        </div>
                        <div class="profile-name">
                            <h5 class="mb-0 font-weight-normal">
                                {{Auth::user()->title}}
                                <br>
                                {{ substr(Auth::user()->name, 0, ceil(strlen(Auth::user()->name) / 2)) }}
                                <br>
                                {{ substr(Auth::user()->name, ceil(strlen(Auth::user()->name) / 2)) }}
                            </h5>
